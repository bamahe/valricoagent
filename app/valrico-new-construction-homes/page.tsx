    ...
    <div style={{ maxWidth: 1140, margin: '0 auto', padding: '24px 24px 0' }}>
      <div style={{ background: '#fafafa', border: '1px solid #e8e8e8', borderRadius: 10, padding: '20px 24px', marginBottom: 24 }}>
        <p style={{ fontSize: 15, color: '#222', lineHeight: 1.7, margin: 0 }}>
          <strong>New construction communities in Valrico FL include Valrico Forest ($400K-$525K, Craftsman-style homes), Arista ($425K-$575K, gated community), Heritage Crest ($400K-$500K, modern open-concept designs), and Northwood Estates ($425K-$575K, WestBay Homes with no CDD fees). Prices range from the low $400Ks to $575K+ depending on the community and upgrades selected.</strong>
        </p>
      </div>
    </div>
    ...
    <div className="max-w-[1140px] mx-auto px-7 py-16 space-y-6" style={{color:'var(--ink-soft)'}}>
      ...
      <div className="flex gap-5 items-start p-6 rounded-xl border mt-8" style={{borderColor:'var(--border)',background:'#fafafa'}}>
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed mb-2" style={{color:'var(--ink-soft)'}}>24+ years of real estate experience. Has worked with multiple national and regional builders in Valrico. Free buyer representation at no cost to you. Call to walk through any Valrico builder community.</p>
