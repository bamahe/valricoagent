...
export const metadata: Metadata = {
  ...
  description:
    "Meet Barrett Henry, your Valrico FL REALTOR® and Broker Associate with REMAX Collective. 24+ years of real estate experience, 38 neighborhoods, e-PRO, MRP, SRS designations. Call (813) 733-7907.",
  openGraph: {
    title: "Barrett Henry, REALTOR® - Valrico Real Estate Agent",
    description:
      "Meet Barrett Henry, your Valrico FL REALTOR® and Broker Associate with REMAX Collective. 24+ years of real estate experience, 38 neighborhoods, e-PRO, MRP, SRS designations. Call (813) 733-7907.",
