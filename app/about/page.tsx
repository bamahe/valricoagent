    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({
        "@context":"https://schema.org","@type":"FAQPage","mainEntity":[
          ...
          {"@type":"Question","name":"What areas does Barrett Henry serve?","acceptedAnswer":{"@type":"Answer","text":"Barrett Henry's primary focus is Valrico, covering all 42 neighborhoods across ZIP codes 33594 and 33596. He also serves Brandon, Riverview, and Lithia (including FishHawk Ranch). Barrett handles commercial real estate through REMAX Commercial and manages rental properties through ViVi Property Management. 23+ years of real estate experience. Call (813) 733-7907."}}
        ]
      })}} />
    </>
  );
