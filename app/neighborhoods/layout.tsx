...
export const metadata: Metadata = {
  ...
  description:
    'Explore all 32 Valrico neighborhoods. Compare home prices, school zones, HOA fees, and lifestyle across Bloomingdale, River Hills, Buckhorn, Diamond Hill, and more.',
