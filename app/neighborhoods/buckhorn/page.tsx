...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Buckhorn Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in the Buckhorn / Boyette corridor range from $350K to $500K, which is the most affordable entry point into the Newsome HS zone compared to FishHawk Ranch ($450K-$800K+). Contact Barrett Henry, REALTOR® at (813) 733-7907 for current pricing."}},{"@type":"Question","name":"What school zone is Buckhorn in?","acceptedAnswer":{"@type":"Answer","text":"The Buckhorn corridor is zoned for Newsome High School (A-rated, GreatSchools 8/10), one of the top-performing high schools in Hillsborough County. Feeder schools include Mulrennan Middle. Barrett Henry at (813) 733-7907 can confirm."}},{"@type":"Question","name":"Does Buckhorn have an HOA?","acceptedAnswer":{"@type":"Answer","text":"HOA varies by subdivision within the Buckhorn corridor. Communities like Buckhorn Preserve and Crosby Crossings have mandatory HOAs, while some older sections do not. Call Barrett Henry, REALTOR® at (813) 733-7907 for specific details."}},{"@type":"Question","name":"Is Buckhorn a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"The Buckhorn corridor is one of Valrico's fastest-growing areas, offering Newsome HS zoning at a more accessible price than FishHawk Ranch and without CDD fees in many sections. Barrett Henry, REALTOR® at (813) 733-7907 is the local expert."}}]})}} />
    </>
  );
}
