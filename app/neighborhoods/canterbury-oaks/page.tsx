    ...
    <>
      <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <h1 className="font-serif text-[clamp(26px,4vw,38px)] leading-tight tracking-tight mb-4">Canterbury Oaks Homes for Sale &mdash; Valrico FL 33596</h1>
          <p className="text-lg leading-relaxed max-w-[640px] mb-6" style={{color:'rgba(255,255,255,.75)'}}>Canterbury Oaks is an HOA-governed community in south Valrico (33596) with amenities that include a community pool and tennis courts. Prices from $350K–$475K. Barrett Henry, REALTOR&reg; with RE/MAX Collective.</p>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-4" style={{color:'var(--ink-soft)'}}>Canterbury Oaks is an HOA-governed community in south Valrico (33596) with amenities that include a community pool and tennis courts. The mandatory HOA maintains common areas, enforces architectural standards, and provides recreational access that many families prioritize.</p>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Homes range from approximately 1,500 to 2,600 square feet with 3 to 5 bedrooms. Construction dates from the mid-1990s through early 2000s. The community has a settled, well-maintained appearance with consistent landscaping and property upkeep driven by HOA standards. Pool homes are available but less common than in some other Bloomingdale sections.</p>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Zoned for Bloomingdale High School. The community pool and tennis courts are a significant draw for families who want recreational amenities without joining a private club.</p>

            <h2 className="font-serif text-2xl mb-4 mt-10">Who Canterbury Oaks fits best</h2>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Families who want community pool and tennis access, HOA-maintained standards, and Bloomingdale HS zoning at a mid-range Valrico price point. Buyers who value predictable neighborhood appearance and community amenities.</p>

            <h2 className="font-serif text-2xl mb-4 mt-10">Explore more Valrico neighborhoods</h2>
            <p className="text-[15px] leading-[1.8]" style={{color:'var(--ink-soft)'}}><Link href="/neighborhoods/bloomingdale/" className="no-underline" style={{color:'var(--accent)'}}>Bloomingdale</Link> &middot; <Link href="/neighborhoods/river-hills/" className="no-underline" style={{color:'var(--accent)'}}>River Hills</Link> &middot; <Link href="/neighborhoods/diamond-hill/" className="no-underline" style={{color:'var(--accent)'}}>Diamond Hill</Link> &middot; <Link href="/neighborhoods/buckhorn/" className="no-underline" style={{color:'var(--accent)'}}>Buckhorn</Link> &middot; <Link href="/neighborhoods/twin-lakes/" className="no-underline" style={{color:'var(--accent)'}}>Twin Lakes</Link> &middot; <Link href="/neighborhoods/brentwood-hills/" className="no-underline" style={{color:'var(--accent)'}}>Brentwood Hills</Link> &middot; <Link href="/neighborhoods/crestwood-estates/" className="no-underline" style={{color:'var(--accent)'}}>Crestwood Estates</Link> &middot; </p>
          </div>

          <div className="space-y-6">
            <div className="rounded-md p-6 border" style={{borderColor:'var(--border)',background:'var(--cream-warm)'}}>
              <h3 className="font-serif text-lg mb-3">Talk to Barrett about Canterbury Oaks</h3>
              <p className="text-sm mb-4 leading-relaxed" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR&reg; knows every section of Canterbury Oaks. Get pricing, listings, and neighborhood-specific advice.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:"{\"@context\": \"https://schema.org\", \"@graph\": [{\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Home\", \"item\": \"https://valricoagent.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Neighborhoods\", \"item\": \"https://valricoagent.com/#neighborhoods\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"Canterbury Oaks Homes for Sale\", \"item\": \"https://valricoagent.com/neighborhoods/canterbury-oaks/\"}]}, {\"@type\": \"Place\", \"name\": \"Canterbury Oaks, Valrico FL\", \"address\": {\"@type\": \"PostalAddress\", \"addressLocality\": \"Valrico\", \"addressRegion\": \"FL\", \"postalCode\": \"33596\", \"addressCountry\": \"US\"}, \"geo\": {\"@type\": \"GeoCoordinates\", \"latitude\": 27.9378, \"longitude\": -82.2365}}]}"}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Canterbury Oaks Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Canterbury Oaks range from $350K to $475K. Homes are typically 1,500 to 2,600 sq ft with 3 to 5 bedrooms, built in the mid-1990s through early 2000s. Contact Barrett Henry, REALTOR® at (813) 733-7907 for current pricing."}},{"@type":"Question","name":"What school zone is Canterbury Oaks in?","acceptedAnswer":{"@type":"Answer","text":"Canterbury Oaks is zoned for Bloomingdale High School, one of the top-rated high schools in Hillsborough County. Barrett Henry, REALTOR® at (813) 733-7907 can confirm school assignments for any Canterbury Oaks address."}},{"@type":"Question","name":"Does Canterbury Oaks have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Yes, Canterbury Oaks has a mandatory HOA that maintains the community pool, tennis courts, common areas, and enforces architectural standards. Call Barrett Henry at (813) 733-7907 for current HOA fee information."}},{"@type":"Question","name":"Is Canterbury Oaks a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Canterbury Oaks is a well-maintained community with pool and tennis amenities, Bloomingdale HS zoning, and consistent neighborhood appearance driven by active HOA management. Barrett Henry, REALTOR® at (813) 733-7907 knows this community well."}}]})}} />
    </>
  );
}
