...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Legends Pass Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Legends Pass range from $400K to $550K. Homes are typically 1,800 to 3,000 sq ft with 3 to 5 bedrooms and contemporary floor plans with owners suites and covered lanais. Contact Barrett Henry, REALTOR® at (813) 733-7907."}},{"@type":"Question","name":"What school zone is Legends Pass in?","acceptedAnswer":{"@type":"Answer","text":"School zoning varies by address in the 33594 ZIP code. Barrett Henry, REALTOR® at (813) 733-7907 can verify the exact school zone for any Legends Pass address."}},{"@type":"Question","name":"Does Legends Pass have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Yes, Legends Pass has an HOA that maintains consistent architectural standards and community appearance. Call Barrett Henry at (813) 733-7907 for current HOA fee details."}},{"@type":"Question","name":"Is Legends Pass a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Legends Pass is a strong choice for families who want newer construction with modern floor plans near Diamond Hill and SR-60 in north Valrico, without paying the premium of the 33596 ZIP. Barrett Henry, REALTOR® at (813) 733-7907 is the local expert."}}]})}} />
    </>
  );
}
