...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Bloomingdale Oaks Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Bloomingdale Oaks range from $350K to $475K. Pool homes command a $20K-$40K premium. Homes are typically 1,600 to 2,800 sq ft with 3 to 5 bedrooms. Contact Barrett Henry, REALTOR® at (813) 733-7907 for current pricing."}},{"@type":"Question","name":"What school zone is Bloomingdale Oaks in?","acceptedAnswer":{"@type":"Answer","text":"Bloomingdale Oaks is zoned for Bloomingdale High School and its feeder schools. Consistent school zoning makes this one of the most stable sections for resale value. Call Barrett Henry at (813) 733-7907."}},{"@type":"Question","name":"Does Bloomingdale Oaks have an HOA?","acceptedAnswer":{"@type":"Answer","text":"HOA structure in Bloomingdale Oaks follows the broader Bloomingdale community model. Barrett Henry, REALTOR® at (813) 733-7907 can confirm the current HOA status and fees for any Bloomingdale Oaks property."}},{"@type":"Question","name":"Is Bloomingdale Oaks a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Bloomingdale Oaks is one of the most sought-after sub-neighborhoods in Bloomingdale, known for sidewalks, strong resale value, and established community character. It is popular with families moving up from Brandon. Barrett Henry, REALTOR® at (813) 733-7907 knows every section."}}]})}} />
    </>
  );
}
