    ...
    <>
      <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <p className="text-lg leading-relaxed max-w-[640px] mb-6" style={{color:'rgba(255,255,255,.75)'}}>Newest Craftsman-style homes in north Valrico near Diamond Hill. Prices from $400K–$525K. Barrett Henry, REALTOR&reg; with RE/MAX Collective.</p>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Newest Craftsman-style homes in north Valrico near Diamond Hill. Contemporary floor plans and design.</p>
            <h2 className="font-serif text-2xl mb-4 mt-10">Who Valrico Forest fits best</h2>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Buyers who want brand-new construction in Valrico with modern Craftsman styling.</p>
          ...
          <div className="space-y-6">
            <div className="rounded-md p-6 border" style={{borderColor:'var(--border)',background:'var(--cream-warm)'}}>
              ...
              <p className="text-sm mb-4 leading-relaxed" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR&reg; knows Valrico Forest.</p>
