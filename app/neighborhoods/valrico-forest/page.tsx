    ...
    <>
      ...
      <div style={{ background: 'var(--blue-deep)' }} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <h1 className="font-serif text-[clamp(26px,4vw,38px)] leading-tight tracking-tight mb-4">Valrico Forest Homes for Sale, Valrico FL 33594</h1>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-12">
        <NeighborhoodMap
          center={neighborhoodCoords['valrico-forest']}
          neighborhoodName="Valrico Forest"
        />
      </div>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{ color: 'var(--ink-soft)' }}>The wooded setting creates a neighborhood character that appeals to a specific type of buyer, someone who values privacy, shade, and a connection to nature over the manicured uniformity of a master-planned community. If you drive through Valrico Forest and feel like you&apos;re somewhere other than suburban Tampa Bay, that&apos;s the point. The trade-off is yard maintenance: mature trees mean more leaves, more shade (less grass growth), and occasional tree trimming. For buyers who embrace that, Valrico Forest delivers an experience that&apos;s hard to find at this price point.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-md p-6" style={{ background: 'var(--blue-deep)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'rgba(255,255,255,.7)' }}>Free CMA from Barrett Henry, REALTOR&reg;. Comps pulled from your section of Valrico Forest, not a generic estimate.</p>
