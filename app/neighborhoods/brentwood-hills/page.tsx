...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Brentwood Hills Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Brentwood Hills range from $340K to $475K. Homes are primarily 3 to 5 bedrooms built through the 1990s and 2000s. Contact Barrett Henry, REALTOR® at (813) 733-7907 for current Brentwood Hills pricing."}},{"@type":"Question","name":"What school zone is Brentwood Hills in?","acceptedAnswer":{"@type":"Answer","text":"Brentwood Hills is zoned for Bloomingdale High School (A-rated). The community straddles the 33594 and 33596 ZIP codes. Barrett Henry, REALTOR® at (813) 733-7907 can confirm exact ZIP and school assignment for any address."}},{"@type":"Question","name":"Does Brentwood Hills have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Yes, Brentwood Hills has a mandatory HOA that maintains the community pool, common areas, and enforces community standards. The pool is a major draw for families. Call Barrett Henry at (813) 733-7907 for current HOA fees."}},{"@type":"Question","name":"Is Brentwood Hills a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Brentwood Hills is a strong choice for families who want sidewalks, community pool access, and Bloomingdale HS zoning at a price point below Bloomingdale proper or River Hills. Barrett Henry, REALTOR® at (813) 733-7907 can help you decide."}}]})}} />
    </>
  );
}
