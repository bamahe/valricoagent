      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-4" style={{ color: 'var(--ink-soft)' }}>Brentwood Hills is a family-oriented community straddling the 33594 and 33596 ZIP codes in Valrico. The neighborhood features sidewalks throughout, a community pool maintained by the HOA, and proximity to the Bloomingdale Avenue commercial corridor. These three features &mdash; sidewalks, pool, and walkable shopping &mdash; combine to create one of the most practical family neighborhoods in the Valrico area.</p>
            <p className="text-[15px] leading-[1.8] mb-4" style={{ color: 'var(--ink-soft)' }}>Homes are primarily single-family with 3 to 5 bedrooms built through the 1990s and 2000s. Construction is typical Florida concrete block with stucco exteriors. Many homes have been updated with modern kitchens, impact-rated windows, and renovated bathrooms. The neighborhood layout keeps traffic slow and residential streets quiet &mdash; most streets are cul-de-sacs or loops rather than through roads.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-md p-6" style={{ background: 'var(--blue-deep)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'rgba(255,255,255,.7)' }}>Free CMA from Barrett Henry, REALTOR&reg;. Actual comps from Brentwood Hills &mdash; not a Zestimate.</p>
