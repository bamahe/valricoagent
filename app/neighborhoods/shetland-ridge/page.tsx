...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Shetland Ridge Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Shetland Ridge range from $400K to $550K. Homes are typically 2,000 to 3,200 sq ft with 4 to 5 bedrooms and modern floor plans with open-concept living areas and owners suites. Contact Barrett Henry, REALTOR® at (813) 733-7907."}},{"@type":"Question","name":"What school zone is Shetland Ridge in?","acceptedAnswer":{"@type":"Answer","text":"Shetland Ridge is zoned for Bloomingdale High School. The larger square footage and newer construction make this section appealing to move-up buyers. Barrett Henry, REALTOR® at (813) 733-7907 can confirm school assignments."}},{"@type":"Question","name":"Does Shetland Ridge have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Shetland Ridge has a neighborhood structure with community standards. Contact Barrett Henry, REALTOR® at (813) 733-7907 for specific HOA details on any Shetland Ridge property."}},{"@type":"Question","name":"Is Shetland Ridge a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Shetland Ridge is excellent for move-up buyers who want modern layouts, 4-5 bedrooms, and Bloomingdale HS zoning without paying Crestwood Estates or River Hills prices. Barrett Henry, REALTOR® at (813) 733-7907 specializes in this area."}}]})}} />
    </>
  );
}
