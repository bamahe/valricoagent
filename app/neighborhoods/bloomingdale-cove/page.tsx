    ...
    <>
      ...
      <div style={{ background: 'var(--blue-deep)' }} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <h1 className="font-serif text-[clamp(26px,4vw,38px)] leading-tight tracking-tight mb-4">Bloomingdale Cove Homes for Sale, Valrico FL 33596</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <div className="rounded-md p-6 mt-4 mb-6" style={{ background: 'var(--cream-warm)', border: '1px solid var(--border)', display: 'flex', gap: 20, alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed mb-2" style={{ color: 'var(--ink-soft)' }}>23+ years of Valrico real estate experience including the full Bloomingdale sub-community network in south Valrico 33596. MRP, SRS, e-PRO certified. REMAX Hall of Fame 2024. Barrett knows the pricing differences between Bloomingdale Cove, Bloomingdale East, and Bloomingdale Oaks. <a href="tel:8137337907" className="font-semibold no-underline" style={{ color: 'var(--accent)' }}>(813) 733-7907</a></p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-md p-6" style={{ background: 'var(--blue-deep)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'rgba(255,255,255,.7)' }}>Free CMA from Barrett Henry, REALTOR&reg;. Actual comps from your section of Bloomingdale, not a Zestimate.</p>
