    ...
    <>
      <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <p className="text-lg leading-relaxed max-w-[640px] mb-6" style={{color:'rgba(255,255,255,.75)'}}>Wellington is an HOA-governed community in south Valrico (33596) with established amenities including a community pool and tennis courts. Prices from $375K–$475K. Barrett Henry, REALTOR&reg; with RE/MAX Collective.</p>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-4" style={{color:'var(--ink-soft)'}}>Wellington is an HOA-governed community in south Valrico (33596) with established amenities including a community pool and tennis courts. The neighborhood has a well-maintained, consistent appearance driven by active HOA management.</p>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Homes range from approximately 1,600 to 2,600 square feet with 3 to 5 bedrooms. Construction dates primarily from the 1990s. The community pool and tennis courts provide family recreation without requiring a separate club membership. HOA fees cover amenity maintenance, common area landscaping, and architectural review.</p>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Zoned for Bloomingdale High School. The community amenities and consistent neighborhood standards make Wellington a popular choice for families who want a turnkey community experience.</p>

            <h2 className="font-serif text-2xl mb-4 mt-10">Who Wellington fits best</h2>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Families who want community pool and tennis access with Bloomingdale HS zoning. Buyers who value HOA-maintained common areas, established neighborhood character, and predictable property standards.</p>
          ...
          <div className="space-y-6">
            <div className="rounded-md p-6 border" style={{borderColor:'var(--border)',background:'var(--cream-warm)'}}>
              <h3 className="font-serif text-lg mb-3">Talk to Barrett about Wellington</h3>
              <p className="text-sm mb-4 leading-relaxed" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR&reg; knows every section of Wellington. Get pricing, listings, and neighborhood-specific advice.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:"{\"@context\": \"https://schema.org\", \"@graph\": [{\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Home\", \"item\": \"https://valricoagent.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Neighborhoods\", \"item\": \"https://valricoagent.com/#neighborhoods\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"Wellington Homes for Sale\", \"item\": \"https://valricoagent.com/neighborhoods/wellington/\"}]}, {\"@type\": \"Place\", \"name\": \"Wellington, Valrico FL\", \"address\": {\"@type\": \"PostalAddress\", \"addressLocality\": \"Valrico\", \"addressRegion\": \"FL\", \"postalCode\": \"33596\", \"addressCountry\": \"US\"}, \"geo\": {\"@type\": \"GeoCoordinates\", \"latitude\": 27.9378, \"longitude\": -82.2365}}]}"}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Wellington Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Wellington range from $375K to $475K. Homes are typically 1,600 to 2,600 sq ft with 3 to 5 bedrooms, built primarily in the 1990s. Contact Barrett Henry, REALTOR® at (813) 733-7907 for current Wellington pricing."}},{"@type":"Question","name":"What school zone is Wellington in?","acceptedAnswer":{"@type":"Answer","text":"Wellington is zoned for Bloomingdale High School, one of the top-rated high schools in Hillsborough County. Barrett Henry, REALTOR® at (813) 733-7907 can confirm school assignments for any Wellington address."}},{"@type":"Question","name":"Does Wellington have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Yes, Wellington has a mandatory HOA that maintains the community pool, tennis courts, common areas, and enforces architectural standards. Call Barrett Henry at (813) 733-7907 for current HOA fee details."}},{"@type":"Question","name":"Is Wellington a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Wellington is a well-maintained community with pool and tennis amenities, Bloomingdale HS zoning, and consistent property standards. It is popular with families who want a turnkey community experience. Barrett Henry, REALTOR® at (813) 733-7907 can help."}}]})}} />
    </>
  );
}
