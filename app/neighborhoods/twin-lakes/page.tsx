...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Twin Lakes Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Twin Lakes range from $375K to $475K. Homes are 1,574 to 3,311 sq ft with 3 to 5 bedrooms. Lake-facing lots command $20K-$40K premiums over interior lots. Contact Barrett Henry, REALTOR® at (813) 733-7907 for current pricing."}},{"@type":"Question","name":"What school zone is Twin Lakes in?","acceptedAnswer":{"@type":"Answer","text":"Twin Lakes is zoned for Bloomingdale High School (A-rated). Feeder middle school is Burns Middle School. School zoning is consistent across the community. Barrett Henry, REALTOR® at (813) 733-7907 can confirm."}},{"@type":"Question","name":"Does Twin Lakes have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Twin Lakes has a neighborhood structure with community standards established since 1998. Contact Barrett Henry, REALTOR® at (813) 733-7907 for specific HOA details on any Twin Lakes property."}},{"@type":"Question","name":"Is Twin Lakes a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Twin Lakes is a strong choice for families who want lake views, larger floor plans, and Bloomingdale HS zoning at a mid-range price point with mature landscaping and established community character. Barrett Henry, REALTOR® at (813) 733-7907 knows every section."}}]})}} />
    </>
  );
}
