    ...
    <>
      <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <p className="text-lg leading-relaxed max-w-[640px] mb-6" style={{color:'rgba(255,255,255,.75)'}}>Arista is a gated community of sizable homes located between Valrico Lake and Diamond Hill Golf Course in north Valrico (33594). Prices from $425K–$575K. Barrett Henry, REALTOR&reg; with RE/MAX Collective.</p>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-4" style={{color:'var(--ink-soft)'}}>Arista is a gated community of sizable homes located between Valrico Lake and Diamond Hill Golf Course in north Valrico (33594). The community features newer construction with upscale finishes and a gated entrance that provides an added layer of security and privacy.</p>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Homes range from 2 to 5 bedrooms with modern floor plans and premium finishes. The location between two significant Valrico landmarks (the lake and the golf course) provides scenic surroundings without the cost of direct waterfront or golf course frontage. Gated entry adds both real and perceived security value.</p>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>School zoning varies by address in 33594. The gated format and newer construction make Arista one of the more premium options in north Valrico.</p>

            <h2 className="font-serif text-2xl mb-4 mt-10">Who Arista fits best</h2>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Buyers who want a gated community with newer construction near Diamond Hill and Lake Valrico. Families and professionals who want modern living with security.</p>
          ...
          <div className="space-y-6">
            <div className="rounded-md p-6 border" style={{borderColor:'var(--border)',background:'var(--cream-warm)'}}>
              <h3 className="font-serif text-lg mb-3">Talk to Barrett about Arista</h3>
              <p className="text-sm mb-4 leading-relaxed" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR&reg; knows every section of Arista. Get pricing, listings, and neighborhood-specific advice.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:"{\"@context\": \"https://schema.org\", \"@graph\": [{\"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"Home\", \"item\": \"https://valricoagent.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"Neighborhoods\", \"item\": \"https://valricoagent.com/#neighborhoods\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"Arista Homes for Sale\", \"item\": \"https://valricoagent.com/neighborhoods/arista/\"}]}, {\"@type\": \"Place\", \"name\": \"Arista, Valrico FL\", \"address\": {\"@type\": \"PostalAddress\", \"addressLocality\": \"Valrico\", \"addressRegion\": \"FL\", \"postalCode\": \"33594\", \"addressCountry\": \"US\"}, \"geo\": {\"@type\": \"GeoCoordinates\", \"latitude\": 27.9378, \"longitude\": -82.2365}}]}"}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in Arista Valrico?","acceptedAnswer":{"@type":"Answer","text":"Homes in Arista range from $425K to $575K. Arista is a gated community with newer construction and upscale finishes in north Valrico (33594). Contact Barrett Henry, REALTOR® at (813) 733-7907 for current Arista pricing and availability."}},{"@type":"Question","name":"What school zone is Arista in?","acceptedAnswer":{"@type":"Answer","text":"School zoning varies by specific address within Arista in the 33594 ZIP code. Barrett Henry, REALTOR® at (813) 733-7907 can verify the exact school assignment for any Arista address."}},{"@type":"Question","name":"Does Arista have an HOA?","acceptedAnswer":{"@type":"Answer","text":"Yes, Arista is a gated community with an HOA that maintains the gated entrance and community standards. The gated entry provides added security and privacy. Call Barrett Henry at (813) 733-7907 for current HOA fee details."}},{"@type":"Question","name":"Is Arista a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Arista is one of the more premium gated communities in north Valrico, ideal for buyers who want newer construction, modern floor plans, and a secure gated entrance near Diamond Hill and Lake Valrico. Barrett Henry, REALTOR® at (813) 733-7907 can help you determine if Arista fits your needs."}}]})}} />
    </>
  );
}
