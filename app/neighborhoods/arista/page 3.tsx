    ...
    <>
      <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <p className="text-lg leading-relaxed max-w-[640px] mb-6" style={{color:'rgba(255,255,255,.75)'}}>Arista is a gated community of sizable homes located between Valrico Lake and Diamond Hill Golf Course in north Valrico (33594). Prices from $425K–$575K. Barrett Henry, REALTOR&reg; with REMAX Collective.</p>
