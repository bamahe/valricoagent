...
export default function Page() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How much do homes cost in the Lake Valrico area?","acceptedAnswer":{"@type":"Answer","text":"Homes in the Lake Valrico area range from $350K to $500K. Properties feature waterfront lots, larger acreage (some exceeding one acre), and a mix of custom-built and updated homes. Contact Barrett Henry, REALTOR® at (813) 733-7907."}},{"@type":"Question","name":"What school zone is Lake Valrico in?","acceptedAnswer":{"@type":"Answer","text":"School zoning varies by specific address in the Lake Valrico area (33594 ZIP code). Barrett Henry, REALTOR® at (813) 733-7907 can verify the exact school assignment for any Lake Valrico address."}},{"@type":"Question","name":"Does the Lake Valrico area have an HOA?","acceptedAnswer":{"@type":"Answer","text":"No, many properties in the Lake Valrico area have no HOA, which appeals to buyers who want complete flexibility with their property. Call Barrett Henry at (813) 733-7907 to confirm for specific addresses."}},{"@type":"Question","name":"Is the Lake Valrico area a good neighborhood in Valrico?","acceptedAnswer":{"@type":"Answer","text":"The Lake Valrico area is ideal for buyers who want waterfront living, larger lots, no HOA restrictions, and lake access for fishing and kayaking in a distinctly rural character setting. Barrett Henry, REALTOR® at (813) 733-7907 knows every property around the lake."}}]})}} />
    </>
  );
}
