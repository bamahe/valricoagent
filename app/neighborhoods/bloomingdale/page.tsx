          ...
          <div className="space-y-6">
            ...
            <div className="rounded-md p-6 border" style={{ borderColor: 'var(--border)' }}>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://bestvalricohandyman.com" target="_blank" rel="noopener" className="text-sm no-underline hover:underline" style={{ color: 'var(--accent)' }}>Bloomingdale home repairs &rarr;</a></li>
              </ul>
            </div>
