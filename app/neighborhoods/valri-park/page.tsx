    ...
    <>
      ...
      <div style={{ background: 'var(--blue-deep)' }} className="text-white py-16 px-7">
        <div className="max-w-[1140px] mx-auto">
          ...
          <h1 className="font-serif text-[clamp(26px,4vw,38px)] leading-tight tracking-tight mb-4">Valri Park Homes for Sale, Valrico FL 33594</h1>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{ color: 'var(--ink-soft)' }}>Because zoning boundaries can split through neighborhoods like Valri Park, verifying the exact school assignment before making an offer is critical. Barrett Henry can pull the verified zoning for any Valri Park address, call <a href="tel:8137337907" className="font-semibold no-underline" style={{ color: 'var(--accent)' }}>(813) 733-7907</a>. For a broader overview of Valrico school assignments, see the <Link href="/valrico-school-zones/" className="no-underline font-semibold" style={{ color: 'var(--accent)' }}>Valrico school zone guide</Link>.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-md p-6" style={{ background: 'var(--blue-deep)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'rgba(255,255,255,.7)' }}>Free CMA from Barrett Henry, REALTOR&reg;. Actual neighborhood comps, not a Zestimate.</p>
