      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16 space-y-6" style={{color:'var(--ink-soft)'}}>
        ...
        <div className="flex gap-5 items-start p-6 rounded-xl border mb-8" style={{borderColor:'var(--border)',background:'#fafafa'}}>
          ...
          <div>
            ...
            <p className="text-sm mb-2" style={{color:'var(--ink-soft)'}}>24+ years of real estate experience. Serving 33594 and 33596 daily from the REMAX Collective Brandon office.</p>
        ...
        <p className="text-[15px] leading-[1.8]">24+ years in real estate. Deep knowledge of every subdivision in 33594 and 33596. Broker Associate with REMAX Collective, which means you get the global reach and referral network of one of the most recognized brands in real estate, combined with neighborhood-level knowledge that most agents simply don&apos;t have.</p>
