      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Whether you are an investor looking for a deal or a homebuyer trying to stretch your budget, Barrett can help you find, evaluate, and close on foreclosure properties in Valrico and the surrounding Tampa Bay area.</p>
