    ...
    <div className="max-w-[1140px] mx-auto px-7 py-12">
      ...
      <div className="flex gap-5 items-start mb-10 p-6 rounded-xl border" style={{borderColor:'var(--border)',background:'#fafafa'}}>
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed mb-2" style={{color:'var(--ink-soft)'}}>23+ years of real estate experience in Valrico. e-PRO, MRP, SRS designations. Covering every street in 33596 including Bloomingdale, River Hills, Buckhorn, and Twin Lakes. Free 15-minute consultation.</p>
