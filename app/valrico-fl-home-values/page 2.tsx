      ...
      <div className="max-w-[1140px] mx-auto px-7 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>A comparative market analysis (CMA) from a REALTOR® who works Valrico every day uses actual closed sales from your specific section, adjusts for the things that matter locally, and gives you a number you can actually price from. That&apos;s what I provide — free, no obligation, no pressure to list.</p>
