  ...
  return (
    <>
      ...
      <div className="max-w-[1140px] mx-auto px-7 py-12">
        ...
        <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR® has been selling homes in Valrico since 2003 and knows every neighborhood on this page. Whether you&apos;re a first-time buyer, moving up, relocating from out of state, or looking for an investment property, Barrett provides straight-talk guidance based on local data, not portal algorithms. <a href="tel:8137337907" className="font-semibold no-underline" style={{color:'var(--accent)'}}>Call (813) 733-7907</a> to start your Valrico home search.</p>

        <div className="space-y-4">
          {[['How much do homes cost in Valrico FL?','The median home price in Valrico is approximately $415K as of Q1 2026. Prices range from the low $300Ks to over $1M depending on neighborhood, lot size, and condition.'],['What are the best neighborhoods in Valrico?','Top neighborhoods include Bloomingdale (5,200+ homes, $300K-$500K), River Hills (gated golf, $400K-$800K+), Diamond Hill (gated golf, $350K-$550K+), Buckhorn/Boyette (Newsome HS zone, $350K-$500K), and Twin Lakes ($375K-$475K).'],['Can I find no HOA homes in Valrico?','Yes. Several Valrico neighborhoods have voluntary or no HOA, including sections of Bloomingdale and Lake Valrico. See the no HOA homes page for details.']].map(([q,a])=>(
