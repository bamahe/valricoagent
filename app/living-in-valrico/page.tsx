    ...
    <div className="max-w-[1140px] mx-auto px-7 py-16 space-y-6" style={{color:'var(--ink-soft)'}}>
      ...
      <div className="flex gap-5 items-start p-6 rounded-xl border mt-10" style={{borderColor:'var(--border)',background:'#fafafa'}}>
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed mb-2" style={{color:'var(--ink-soft)'}}>24+ years of real estate experience. MRP (Military Relocation Professional), e-PRO, SRS designations. Serving every Valrico neighborhood in 33594 and 33596. Specializes in relocation buyers from out of state and military families.</p>
