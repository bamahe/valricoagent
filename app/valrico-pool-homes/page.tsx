...
export default function PoolHomes() {
  return (<>
    <div style={{background:'var(--blue-deep)'}} className="text-white py-16 px-7"><div className="max-w-[1140px] mx-auto">
      <h1 className="font-serif text-[clamp(28px,4vw,38px)] leading-tight tracking-tight mb-4">Valrico Pool Homes for Sale - FL Homes with Pools in 33594 &amp; 33596</h1>
    ...
    <div className="max-w-[1140px] mx-auto px-7 py-16 space-y-6" style={{color:'var(--ink-soft)'}}>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({
        "@context":"https://schema.org","@type":"FAQPage","mainEntity":[
          ...
          {"@type":"Question","name":"How much does it cost to maintain a pool in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Professional pool maintenance in Valrico runs $100-$200 per month. DIY pool owners spend approximately $50-$80 per month on chemicals and supplies. Additional costs include pool cage maintenance, resurfacing (every 10-15 years, $4,000-$8,000), and equipment replacement. Saltwater systems have lower ongoing chemical costs than traditional chlorine pools."}},
          {"@type":"Question","name":"Does a pool add value to a home in Valrico?","acceptedAnswer":{"@type":"Answer","text":"Yes, a well-maintained screened pool typically adds $20K-$40K in value to a Valrico home. However, a pool with a deteriorated cage, outdated equipment, or needed resurfacing can actually reduce perceived value because buyers factor in repair costs. Heated pools and saltwater systems command additional premiums. Pool condition is one of the key inspection items Barrett evaluates for sellers."}},
          {"@type":"Question","name":"What neighborhoods in Valrico have the most pool homes?","acceptedAnswer":{"@type":"Answer","text":"Pool homes are most common in Bloomingdale, River Hills, Diamond Hill, and the Buckhorn corridor. New construction communities like Valrico Forest and Arista sometimes offer pool-ready packages from the builder. Barrett Henry can filter current Valrico listings by pool to find exactly what you are looking for. Call (813) 733-7907."}},
          {"@type":"Question","name":"Does a pool affect homeowners insurance in Florida?","acceptedAnswer":{"@type":"Answer","text":"A well-maintained pool with current equipment and an intact screen cage generally does not significantly increase insurance costs. However, pools without proper fencing or cages may trigger additional liability requirements. Florida insurers require a 4-point inspection for homes over 15 years old, and pool equipment condition is part of that evaluation."}}
        ]
      })}} />
  </>);
}
