...
export default function ValricoPreForeclosure() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14">
          <div>
            ...
            <div className="space-y-4 mb-10">
              {[
                ['Loan modification','Your lender adjusts the terms of your mortgage, lower interest rate, extended term, or reduced principal, to make payments affordable. You keep the home and stay current on a modified payment. This is usually the first option to explore.'],
            ...
            <div className="space-y-4">
              {[
                ...
                ['Will the bank really work with me on a loan modification?','Banks lose money on foreclosures. Most lenders prefer to modify the loan and keep a performing borrower over the cost and timeline of a foreclosure lawsuit. But you have to initiate the process, the bank will not offer it to you unprompted.'],
          ...
          <div className="space-y-6">
            <div className="rounded-md p-6 border" style={{borderColor:'var(--border)',background:'var(--cream-warm)'}}>
              ...
              <p className="text-sm mb-4 leading-relaxed" style={{color:'var(--ink-soft)'}}>Barrett Henry, REALTOR® at REMAX Collective. 24+ years of real estate experience. Free consultation, no judgment, no obligation.</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@type":"RealEstateAgent","name":"Barrett Henry","jobTitle":"REALTOR® & Broker Associate","url":"https://valricoagent.com/valrico-pre-foreclosure/","telephone":"(813) 733-7907","email":"barrett@nowtb.com","image":"https://valricoagent.com/barrett-henry.jpg","address":{"@type":"PostalAddress","addressLocality":"Valrico","addressRegion":"FL","addressCountry":"US"},"worksFor":{"@type":"RealEstateOrganization","name":"REMAX Collective"},"description":"Barrett Henry is a REALTOR® and Broker Associate at REMAX Collective with 24+ years of real estate experience, helping Valrico homeowners navigate pre-foreclosure options."})}} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "Pre-Foreclosure Help", "item": "https://valricoagent.com/valrico-pre-foreclosure/" },
        ]
      }) }} />
    </>
  );
