...
export default function MarketReport() {
  return (<>
    ...
    <div className="max-w-[1140px] mx-auto px-7 py-16 space-y-6" style={{color:'var(--ink-soft)'}}>
      ...
      <div className="border rounded-md p-6 hover:shadow-md transition-shadow mb-4" style={{borderColor:'var(--border)'}}>
        <Link href="/blog/valrico-housing-market-q3-2026/" className="no-underline"><h3 className="font-serif text-xl mb-2" style={{color:'var(--ink)'}}>Valrico Housing Market Q3 2026</h3><p className="text-sm">Summer 2026 market data: median prices, inventory shifts, days on market by neighborhood, and what it means for buyers and sellers in 33594 and 33596.</p><span className="text-xs mt-2 inline-block" style={{color:'var(--accent)'}}>Read the full report &rarr;</span></Link>
      </div>
