...
export const metadata = {
  ...
  openGraph: {
    title: "First-Time Home Buyer Guide for Valrico, FL",
    description: "Down payment programs, neighborhoods by budget, school zones, and step-by-step buying guide for Valrico FL. Barrett Henry, REMAX Collective.",
          ...
          <div>
            ...
            <div className="space-y-6 mb-10">
              ...
              <div className="border rounded-md p-6" style={{borderColor:'var(--border)'}}>
                ...
                <p className="text-[15px] leading-[1.8]" style={{color:'var(--ink-soft)'}}>At this price point you&apos;re looking at 3-bedroom, 2-bath homes built in the 1980s and 1990s. Smaller lots, older roofs, and likely no pool. <strong>Neighborhoods:</strong> Valri Park, sections of Bloomingdale (older phases), parts of Lake Valrico, and some of the non-HOA pockets off Lithia Pinecrest. These homes need updates but they get you into Valrico&apos;s school zones and location. Good starter homes if you&apos;re handy or willing to live with cosmetic issues for a few years.</p>
              </div>

              {/* $350K-$450K */}
              <div className="border rounded-md p-6" style={{borderColor:'var(--border)'}}>
                <h3 className="font-semibold text-lg mb-2" style={{color:'var(--ink)'}}>$350K – $450K: The Sweet Spot</h3>
                <p className="text-[15px] leading-[1.8]" style={{color:'var(--ink-soft)'}}>This is where most first-time buyers in Valrico land. You get 4 bedrooms, 2 baths, updated kitchens, and sometimes a pool. <strong>Neighborhoods:</strong> Bloomingdale (newer sections), Bloomingdale Oaks, Twin Lakes, Buckhorn Preserve, and parts of Buckhorn/Boyette corridor. Many of these are in the Newsome HS zone, which adds value. Expect HOA fees of $50-$150/month in most of these communities.</p>
              </div>

              {/* $450K+ */}
              <div className="border rounded-md p-6" style={{borderColor:'var(--border)'}}>
                <h3 className="font-semibold text-lg mb-2" style={{color:'var(--ink)'}}>$450K+: Upgraded Valrico</h3>
                <p className="text-[15px] leading-[1.8]" style={{color:'var(--ink-soft)'}}>Larger lots, newer construction, pools, 3-car garages, and premium school zones. <strong>Neighborhoods:</strong> Arista, Diamond Hill, Brentwood Hills, River Hills (entry-level homes), and newer builds in the Boyette Road corridor. At $500K+ you start seeing 5-bedroom homes and properties on half-acre lots. If you can stretch to this range, you get significantly more home and better long-term appreciation.</p>
              </div>
            </div>

            {/* DOWN PAYMENT OPTIONS */}
            <h2 className="font-serif text-2xl mb-4 mt-10">Down Payment Options for Valrico Buyers</h2>
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>The biggest myth in real estate: you need 20% down. You don&apos;t. Here are the real options available to Valrico buyers right now.</p>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                ['VA (0% down)','If you\'re a veteran or active military, VA loans are the best deal in real estate. Zero down payment, no PMI, and competitive interest rates. If you qualify, use this. Period.'],
            ...
            <p className="text-[15px] leading-[1.8] mb-6" style={{color:'var(--ink-soft)'}}>Valrico is split between two main high school zones: <strong>Bloomingdale High School</strong> and <strong>Newsome High School</strong>. This matters more than most first-time buyers realize.</p>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                ['5. Inspection Period','You\'ll hire a licensed home inspector (Barrett has recommendations). The inspection report is your negotiation tool. Roof issues, AC problems, plumbing concerns — this is where you protect yourself.'],
